...
class MachineService {
  ...
  /**
   * Realiza uma requisição POST para criar uma nova máquina.
   *
   * @async
   * @param {string} endpoint - O endpoint da API para enviar os dados da nova máquina.
   * @param {machinePostType} data - Os dados da máquina a ser criada.
   * @returns {Promise<AxiosResponse>} A resposta da requisição HTTP.
   * @throws {AxiosError} Se houver erro durante a requisição.
   */
  ...
  /**
   * Realiza uma requisição PUT para atualizar os dados de uma máquina existente.
   *
   * @async
   * @param {string} endpoint - O endpoint da API para atualizar os dados da máquina.
   * @param {number} id - O ID da máquina a ser atualizada.
   * @param {machinePostType} data - Os novos dados da máquina.
   * @returns {Promise<AxiosResponse>} A resposta da requisição HTTP.
   * @throws {AxiosError} Se houver erro durante a requisição.
   */
  async update(
  ...
  /**
   * Realiza uma requisição DELETE para remover uma máquina.
   *
   * @async
   * @param {string} endpoint - O endpoint da API para excluir a máquina.
   * @param {number} id - O ID da máquina a ser removida.
   * @returns {Promise<AxiosResponse>} A resposta da requisição HTTP.
   * @throws {AxiosError} Se houver erro durante a requisição.
   */
